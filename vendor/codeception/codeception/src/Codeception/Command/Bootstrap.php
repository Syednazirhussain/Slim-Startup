 ...
 * * `codecept bootstrap --namespace Frontend` - creates tests, and use `Frontend` namespace for actor model and helpers.
        ...
        $this->setDefinition(
            [
                ...
                new InputOption(
                    ...
                    'Namespace to add for actor model and helpers'
                ),
