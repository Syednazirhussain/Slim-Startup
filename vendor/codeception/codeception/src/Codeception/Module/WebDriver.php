 ...
 * ## Public Properties
 *
 * * `webDriver` - instance of `\Facebook\WebDriver\Remote\RemoteWebDriver`. Can be accessed from Helper model for complex WebDriver interactions.
 *
 * ```php
 * // inside Helper class
    ...
    RequiresPackage
{
     ...
     *
     * Use it in Helpers or GroupObject or Extension model:
     *
     * ```php
     * <?php
