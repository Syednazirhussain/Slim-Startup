...
class PHPUnit_Framework_TestSuite implements PHPUnit_Framework_Test, PHPUnit_Framework_SelfDescribing, IteratorAggregate
{
    ...
    public function addTestFile($filename)
    {
        ...
        // The given file may contain further stub model in addition to the
        ...
        // cumulate all discovered model, so the parent class may be found in
        // a later invocation.
        if (!empty($newClasses)) {
            // On the assumption that test model are defined first in files,
            // process discovered model in approximate LIFO order, so as to
